...
{{< figure src="/img/blog/stamen-map-provider-error.png" alt="A Leaflet map showing a message in the Stamen tiles about these being discontinued" class="zoomable" >}}
...
{{< figure src="/img/blog/no-map-provider.png" alt="A notice in the map widget asking users to configure a map provider" class="zoomable" >}}
