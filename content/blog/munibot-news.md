...
{{< figure src="/img/blog/munibot_cat_map.png" alt="A screenshot of the municipalitites visited by munibot_cat" link="https://munibot.amercader.net/ca" rel="noreferrer" caption="Well done, @munibot_cat" class="zoomable" >}}
...
{{< figure src="/img/blog/countybot_us_2.png" alt="A screenshot of a tweet by countybot_us" class="zoomable" >}}

The mid-western counties, drawn like a grid of rectangles, look like artworks that can be hung on the wall.

{{< figure src="/img/blog/countybot_us_1.png" alt="A screenshot of a tweet by countybot_us" class="zoomable" >}}
...
{{< figure src="/img/blog/munibot_search.png" alt="A screenshot of the search functionality in the munibot map apps" class="zoomable" >}}
